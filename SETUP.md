...
Install opencode (the AI coding CLI):

```bash
npm install -g @anthropic-ai/claude-code
```

Follow the [opencode documentation](https://opencode.ai) for setup and configuration.
...
Reconfiguring search queries is especially useful as your priorities evolve. It re-runs the search configuration interview and suggests role types you may not have considered based on your full profile.
...
> "Evaluate this job posting: https://jobindex.dk/job/1234567"

Or paste the job description directly:

> "Evaluate this job posting: [paste job description text here]"
